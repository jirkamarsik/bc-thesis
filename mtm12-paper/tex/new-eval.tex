...
using the bakeoff evaluation scripts, see
Table~\ref{tbl:bakeoff-score}. The results achieved are approximately
a median of the scores reached by submissions to the Bakeoff.
